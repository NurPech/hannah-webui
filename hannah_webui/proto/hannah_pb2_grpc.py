...
class HannahServiceStub:
    ...
    def __init__(self, channel):
        ...
        self.DeleteSatellite = channel.unary_unary(
                ...
                request_serializer=hannah__pb2.DeleteSatelliteRequest.SerializeToString,
                response_deserializer=hannah__pb2.StatusResponse.FromString,
                _registered_method=True)
...
def add_HannahServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'DeleteSatellite': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=hannah__pb2.DeleteSatelliteRequest.FromString,
                    response_serializer=hannah__pb2.StatusResponse.SerializeToString,
            ),
...
class HannahService:
    ...
    def DeleteSatellite(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/hannah.HannahService/DeleteSatellite',
            hannah__pb2.DeleteSatelliteRequest.SerializeToString,
            hannah__pb2.StatusResponse.FromString,
            options,
            channel_credentials,
            insecure,
